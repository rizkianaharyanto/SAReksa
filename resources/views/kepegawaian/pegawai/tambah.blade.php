...
<div>
  ...
  @csrf
    ...
    <div class="form-group row">
      ...
      <div class="col-10">
        <input class="form-control @error('kode_pegawai') is-invalid @enderror" type="text" id="kode_pegawai" name="kode_pegawai">
      </div>
    </div>
    ...
    <div class="form-group row">
      <label for="kode_pos" class="col-2 col-form-label">kode_pos</label>
      <div class="col-10">
    ...
    <div class="form-group row">
      ...
      <div class="col-10">
        <input class="form-control @error('npwp') is-invalid @enderror" type="number" id="npwp" name="npwp">
      </div>
    </div>

    <div class="form-group row">
      <label for="jabatan" class="col-2 col-form-label">PTKP</label>
      <div class="col-10">
