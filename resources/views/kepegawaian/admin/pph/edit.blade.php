...
<div>
  ...
  @csrf
    ...
    <label for="batas_minimal" class="col-2 col-form-label">Minimal</label>
    <div class="col-10">
    ...
    <div class="form-group row">
    <label for="batas_maksimal @error('batas_maksimal') is-invalid @enderror" class="col-2 col-form-label">Maksimal</label>
    <div class="col-10">
    ...
    <div class="form-group row">
    <label for="persentase" class="col-2 col-form-label">Persentase Pajak</label>
    <div class="col-10">
