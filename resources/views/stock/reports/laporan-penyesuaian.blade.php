...
@section('isi')
<form action="/stok/reports/laporan-penyesuaian/export" class="d-flex justify-content-end">
...
<div class="row">
    ...
    <div class="col-xl-4 col-lg-12 col-md-4 col-sm-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/stok/reports/laporan-penyesuaian/filter" class="form-group">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($item->pivot->quantity_diff < 0) {{$item->pivot->quantity_diff}} 
                                    @else 0
                                    @endif 
                                </td> 
                                <td>
