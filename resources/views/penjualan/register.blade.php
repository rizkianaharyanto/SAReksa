               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <select class="form-control"  id="role" name="role">
                        <option value="penjualan">Admin Penjualan</option><option value="retur">Admin Retur Penjualan</option><option value="piutang">Admin Piutang</option><option value="direksi">Direksi Perusahaan</option>
                     </select>                    
                </div>
                  <div class="form-group">
