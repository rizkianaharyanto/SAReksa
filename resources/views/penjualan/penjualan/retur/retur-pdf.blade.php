                        ...
                        <table>
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    Sales: {{$retur->penjual->nama_penjual}}<br>
                    ...
                    <td colspan="5">
                        <table>
                            <tr>
                                ...
                                <td class="text-right">
                                {{$retur->pelanggan->nama_pelanggan}}<br>
                                {{$retur->pelanggan->alamat_pelanggan}}<br>
                                    {{$retur->pelanggan->email_pelanggan}}
                                </td>
                            </tr>
                        </table>
                    </td>
