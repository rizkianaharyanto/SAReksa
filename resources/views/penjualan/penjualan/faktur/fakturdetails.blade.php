                                    ...
                                    <div class="card-body">
                                            ...
                                            <!-- <div style="overflow:auto; height: 80vh;" class="m-2">
                                                ...
                                                <table class="table table-sm">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Pelanggan : {{$faktur->pelanggan->nama_pelanggan}}</td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <div class="invoice-box">
                                            <table cellpadding="0" cellspacing="0">
                                                        ...
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td class="text-right">
                                                                    ...
                                                                    Sales: {{$faktur->penjual->nama_penjual}}<br>
                                                                    Status: {{$faktur->status}}<br>
                                                    ...
                                                    <td colspan="5">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                {{$faktur->pelanggan->nama_pelanggan}}<br>
                                                                {{$faktur->pelanggan->alamat_pelanggan}}<br>
                                                                    {{$faktur->pelanggan->email_pelanggan}}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr class="item"> 
                                                    <td colspan="4" class="text-right pr-3">Uang muka</td>
                                                    <td id="biaya_lain">@currency($uang_muka)</td>
                                                </tr>
                                                <tr class="total">
                                                    <td colspan="4" class="text-right pr-3">Total</td>
