        ...
        <div class="invoice-box">
            <table cellpadding="0" cellspacing="0">
                    ...
                    <td colspan="6">
                        <table>
                            <tr>
                                ...
                                <td class="text-right">
                                    Pemesanan<br>
                                    {{$pemesanan->kode_pemesanan}}<br>
                                    {{$gudang->kode_gudang}}<br>
                                    Sales: {{$pemesanan->penjual->nama_penjual}}<br>
                    ...
                    <td colspan="6">
                        <table>
                            <tr>
                                ...
                                {{$pemesanan->pelanggan->nama_pelanggan}}<br>
                                {{$pemesanan->pelanggan->alamat_pelanggan}}<br>
                                    {{$pemesanan->pelanggan->email_pelanggan}}
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr class="item">
                    ...
                    <td>
                    {{ $barang->pivot->status_barang ? $barang->pivot->status_barang : '-' }}
                    </td>
                    <td>
