                    ...
                    <td colspan="5">
                        <table>
                            <tr>
                                ...
                                <td class="text-right">
                                    Pengiriman<br>
                                    {{$pengiriman->kode_pengiriman}}<br>
                                    {{$gudang->kode_gudang}}<br>
                                    Sales: {{$pengiriman->penjual->nama_penjual}}<br>
                    ...
                    <td colspan="5">
                        <table>
                            <tr>
                                ...
                                <td class="text-right">
                                {{$pengiriman->pelanggan->nama_pelanggan}}<br>
                                {{$pengiriman->pelanggan->alamat_pelanggan}}<br>
                                    {{$pengiriman->pelanggan->email_pelanggan}}
                                </td>
                            </tr>
                        </table>
                    </td>
