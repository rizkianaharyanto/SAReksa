...
@section('judul', 'Ubah Pembayaran')

@section('halaman', 'Ubah Pembayaran')
                ...
                <div id="test-l-2" class="content">
                    <div style="overflow: auto; " id="formhutang">
                        ...
                        <div class="form-row mx-5" id="isiformhutang0">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="date" class="form-control" id="tanggal_hutang" value="{{$hutang->faktur->tanggal}}" disabled>
                            </div>
                    ...
                    <!-- <div class="alert alert-primary mt-3 mb-0 p-1" id="tambahhutang" onclick="hitung()" onmouseover="green(this)" onmouseout="grey(this)" style="cursor: pointer; font-size:15px;">
                        <i class="fas fa-plus d-flex justify-content-center">
                            <span class="mx-2">Ubah hutang</span>
                        </i>
                    </div> -->
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn" onclick="hitung()" style="background-color:#00BFA6; color:white">Ubah</button>
                    </div>
                </div>
            </form>
        </div>
