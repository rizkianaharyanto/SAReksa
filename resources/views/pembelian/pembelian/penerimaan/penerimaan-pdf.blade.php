                ...
                <div class="card row">
                    <div class="col">
                                <div class="card-header p-4">
                                     <a class="pt-2 d-inline-block">Penerimaan Pembelian</a>
                                    <input type="hidden" name="id" value="{{$penerimaan->id}}">
                                    <div class="float-right"> <h3 class="mb-0">{{$penerimaan->kode_penerimaan}}</h3>
                                    {{$penerimaan->tanggal}}</div>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-sm-6">
                                            <h5 class="mb-3">Pemasok:</h5>                                            
                                            <h3 class="text-dark mb-1">{{$penerimaan->pemasok->nama_pemasok}}</h3>
                                         
                                            <div>{{$penerimaan->pemasok->alamat_pemasok}}</div>
                                            <div>Phone: {{$penerimaan->pemasok->telp_pemasok}}</div>
                                        </div>
