            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div style="margin-bottom :10vh;">
                        <h5 class="mb-3" style="opacity: 80%">{{ $pemesanan->kode_pemesanan }} - {{ $pemesanan->pemasok->nama_pemasok }}</h5>
                        ...
                        <div class="table-responsive-sm mb-5">
                            <table class="table table-sm table-striped">
                                ...
                                <tbody>
                                    @foreach ($pemesanan->barangs as $index => $barang)
                                    <tr>
                    ...
                    <div class="d-flex justify-content-between">
                        <h5 class="mb-3" style="opacity: 80%">Kode Pemesanan : {{ $pemesanan->kode_pemesanan }}</h5>
                    </div>
                    <div class="table-responsive-sm">
                        <table class="table table-sm table-striped">
                            <thead>
