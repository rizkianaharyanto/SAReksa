            ...
            <form method="POST" action="/pembelian/fakturs/{{$faktur->id}}">
                ...
                <div id="test-l-2" class="content">
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="mr-5" id="pemesanan_form">
                            <select class="form-control" id="pemesanan_id" name="pemesanan_id">
                                <option value="">---Pilih Pemesanan---</option>
                                <option value="{{$fpemesanans->id}}" selected>{{$fpemesanans->kode_pemesanan}}</option>
                        ...
                        <div style="overflow: auto; " id="formbarang">
                            ...
                            <div class="form-row mx-5" id="isiformbarang0">
                                ...
                                <div class="form-group col-md-1">
                                    ...
                                    <input type="number" min="0" value="{{$fakturbarang->pivot->jumlah_barang}}" class="form-control" id="jumlah_barang" name="jumlah_barang[]" onfocus="startCalc(this);" onblur="stopCalc();" placeholder="-">
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="satuan_unit">Unit</label>
                                    <input type="number" min="0" placeholder="{{$fakturbarang->pivot->unit}}" class="form-control" id="uni" disabled>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" min="0" value="{{$fakturbarang->pivot->harga}}" class="form-control" id="harga" name="harga[]" onfocus="startCalc(this);" onblur="stopCalc();" placeholder="-">
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                    ...
                    <div class="modal-footer">
                        <div class="d-flex mr-auto">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input style="width:26vw" type="number" min="0" value="{{$faktur->akun_barang}}" name="total_harga_barang" id="total_harga_barang" disabled>
                            </div>
                        </div>
                        <a href="/pembelian/fakturs">
                            <button type="button" class="btn btn-secondary">Batal</button>
                        ...
                        <div class="form-group row mx-5 mb-5">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="number" min="0" class="form-control" id="disko" onchange="disc();" value="{{$faktur->diskon}}" disabled>
                                    <input type="hidden" class="form-control" value="{{$faktur->diskon}}" id="diskon" name="diskon" placeholder="-">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="number" min="0" class="form-control" id="diskoo" onchange="disc();" value="{{$faktur->diskon_rp}}" disabled>
                                    <input type="hidden" class="form-control" id="disk" value="{{$faktur->diskon_rp}}" name="disk" placeholder="-">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row mx-5 mb-5">
                    ...
                    <div class="modal-footer">
                        <div class="d-flex mr-auto">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input style="width:26vw" type="number" min="0" id="total_harga_kes" value="{{$faktur->total_harga}}" disabled>
...
<div class="col-sm-12">
    <div class="alert  alert-danger alert-dismissible fade show" role="alert">
        <span class="badge badge-pill badge-warning">Maaf</span> Faktur yang dibuat berdasarkan penerimaan tidak dapat diubah. Silahkan hapus dan buat faktur baru jika terjadi kesalahan pada faktur ini.
    </div>
</div>
<center>
    <a href="/pembelian/fakturs"><button class="btn btn-dark">Kembali</button></a>
</center>
@endif
