...
@section('isi')
<form action="/pembelian/permintaans/cetak_pdf">
                        ...
                        <div class="offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header p-4">
                                    ...
                                    <div class="float-right"> <h3 class="mb-0">{{$permintaan->kode_permintaan}}</h3>
                                    {{$permintaan->tanggal}}</div>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-sm-6">
    ...
    <!-- <center class="mb-4">
		<h5>Permintaan Penawaran Harga</h4>
        <input type="hidden" name="id" value="{{$permintaan->id}}">
    </center>
