...
class Pemesanan extends Model
{
    ...
    {
        return $this->belongsToMany('App\Stock\Barang', 'pnj_pemesanan_details')->withTimestamps()->withPivot('jumlah_barang', 'harga', 'unit', 'pajak', 'status_barang', 'barang_belum_diterima');
    }
}
